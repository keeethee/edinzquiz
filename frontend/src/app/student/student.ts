...
import { ApiService, Course, Question, Option, Quiz, Assignment, QuizSubmission, StudentAnswer } from '../services/api.service';
...
export class StudentComponent implements OnInit, OnDestroy {
  ...
  submitAssignment() {
    this.errorMsg = '';
    if (!this.loggedInStudent || !this.selectedFile || !this.activeCourse) {
